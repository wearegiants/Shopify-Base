...
<div class="fs-row">
	...
	<div class="fs-cell fs-xl-3 fs-lg-4 fs-md-full fs-sm-3">
		...
		<form class="product-add">
			<div class="fs-row">
				<div class="product-add__size fs-cell fs-lg-8 fs-md-half fs-sm-half fs-xs-full">
					<label>Size</label>
					<select>
				...
				<div class="product-add__qty fs-cell fs-lg-4 fs-md-half fs-sm-half fs-xs-full">
